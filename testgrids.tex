...
\newcommand\loadgrid[1]{%
  \node[anchor=south west,inner sep=0] (image) at (0,0)
       {\includegraphics[scale=0.2,viewport=0 0 3748 2860]{assets/#1}};
...
\node[anchor=south west,inner sep=0] (image) at (0,0)
     {\includegraphics[scale=0.2,viewport=0 0 3748 2732]{assets/terrain-001.jpg}};
...
\begin{tikzpicture}[x=0.5pt,y=0.5pt]
  ...
  \node[anchor=west,inner sep=0] (image) at (0,0)
       {\includegraphics*[scale=0.5,angle=90,viewport={140 140 260 260}]{\fhpath/fh-algox-archer-0.png}};
...
\node[anchor=south,inner sep=0] (image) at (0,0)
     {\includegraphics*[scale=0.2,viewport=1230 1640 1660 2100]{assets/terrain-001.jpg}};
...
\begin{tikzpicture}[x=0.2pt,y=0.2pt]
\node[anchor=south,inner sep=0] (image) at (0,0)
     {\includegraphics*[scale=0.1,viewport=1230 1640 1660 2100]{assets/terrain-001.jpg}};
...
\newcommand\deftile[5][0.1]{% [scale]\ladder{4}{Ladders}{coordinates}
  ...
  \begin{tikzpicture}[x=0.2pt,y=0.2pt]
  \node[anchor=south,inner sep=0] (image) at (0,0)
       {\includegraphics*[scale=#1,viewport=#5]{assets/\tilejpg}};
